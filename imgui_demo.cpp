...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Stack Layout"))
	{
		...
		if (ImGui::IsItemHovered())
			ImGui::SetTooltip("BC Spring Weight = 1 - AB Spring Weight");
		ImGui::DragFloat("Minor Axis Alignment", &alignment, 0.002f, 0.0f, 1.0f);
		if (ImGui::IsItemHovered())
			ImGui::SetTooltip("This is vertical alignment for horizontal layouts and horizontal alignment for vertical layouts.");
